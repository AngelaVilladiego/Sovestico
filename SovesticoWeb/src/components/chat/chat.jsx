...
function Chat({ className }) {
  ...
  return (
    <div className={`${className} flex flex-col px-8`}>
      <div className="h-full w-full relative">
        <div className="absolute top-0 left-0 pt-6 right-0 bottom-0">
          <div className="flex flex-col-reverse gap-8 h-full overflow-y-auto">
      ...
      <div className="send-message-container py-3 w-full">
